###############################################################################################
# --------------------------------------------------------------------------------------------#
# Supplementary Figure S3 generation - 
...
# ----- Necessary gene lists : Supplement File S4 - DMP derived genes, Supplementary File S5 - literature derived genes
geneList_DMPs <- read.delim('./Materials/Supplementary_File_S4.txt')
geneList_Lit <- read.delim('./Materials/Supplementary_File_S5.txt')
...
####################################################################
# 3. Curation of relevant results into an oncoplot
####################################################################
...
pdf('./Figures/Supplementary_Figure_S3a.pdf', height = 11, width = 11)
oncoplot(
